        ...
        for file_path in current_files:
            try:
                ...
                try:
                    ...
                    # Fallback: use os.path.relpath for incompatible paths
                    import os

                    relative_path = os.path.relpath(str(file_path), str(project_root_path))
...
async def main():
    ...
    traversal = FileTraversal(neo4j_uri="bolt://localhost:7687", neo4j_user="neo4j", neo4j_password="password")
